/* Generated By:JavaCC: Do not edit this line. Word2VecTokenizerTokenManager.java */
package tokenizer;
import java.io.*;

/** Token Manager. */
public class Word2VecTokenizerTokenManager implements Word2VecTokenizerConstants
{
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               case 0:
                  ...
                  else if ((0x8400500200000000L & l) != 0L)
                  {
                     if (kind > 8)
                        kind = 8;
                  }
               ...
               case 7:
                  ...
                  break;
               case 9:
                  if ((0x8400500200000000L & l) != 0L && kind > 8)
                     kind = 8;
                  break;
               case 10:
                  if ((0x3ff500000000000L & l) == 0L)
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 8:
                  ...
                  break;
               case 9:
                  if ((0x2800000000000000L & l) != 0L && kind > 8)
                     kind = 8;
                  break;
               case 12:
                  if ((0x7fffffe07fffffeL & l) != 0L)
...
static final int[] jjnextStates = {
   72, 76, 42, 59, 70, 7, 8, 16, 17, 1, 2, 5, 6, 12, 13, 37, 
   40, 44, 53, 61, 67, 73, 75, 77, 78, 
};
...
/** Constructor. */
public Word2VecTokenizerTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public Word2VecTokenizerTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
